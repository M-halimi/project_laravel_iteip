                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                    ...
                                    <a class="text-center" href="index.html"> <h4>Iteip</h4></a>
        
                                <form class="mt-5 mb-5 login-input"  action="{{ route('admin.store') }}" method="POST">
                                    @csrf
                                    <div class="form-group ">
                                        <select name="type" class="form-control selected">
                                            <option value="select">Open select type </option>
                                    ...
                                    <div class="form-group">
                                        <input type="password" name="verified_password" class="form-control" placeholder="verified_password">
                                    </div>
